...
urlpatterns = [
    ...
    path("locations/<int:id>/edit", views.LocationEditView.as_view(), name="ui_locations_edit"),
    path("locations/<int:id>/delete", views.LocationDeleteView.as_view(), name="ui_location_delete"),
    ...
    path("presets/<int:id>/edit", views.PresetEditView.as_view(), name="ui_presets_edit"),
    path("presets/<int:id>/delete", views.PresetDeleteView.as_view(), name="ui_preset_delete"),
