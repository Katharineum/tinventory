    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "number",
                    models.IntegerField(
                        blank=True, null=True, unique=True, verbose_name="Schranknummer"
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_within_school",
                    models.BooleanField(default=False, verbose_name="Schulintern?"),
                ),
                (
                    "is_technician",
                    models.BooleanField(
                        default=False, verbose_name="Aktiver Techniker?"
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "manufacturer",
                    models.CharField(
                        blank=True, max_length=100, verbose_name="Hersteller"
                    ),
                ),
                (
                    "description",
                ...
                (
                    "image",
                    models.ImageField(
                        blank=True, upload_to="images/presets/", verbose_name="Bild"
                    ),
                ),
                (
                    "category",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "check_in_until",
                    models.DateField(
                        blank=True, null=True, verbose_name="Check-In bis"
                    ),
                ),
                (
                    "borrowing_person",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "checked_in_at",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Check-In-Zeitpunkt"
                    ),
                ),
                (
                    "check_out",
